...
| BR-04 | `itPriority` and `ownerId` exist in the data model for forward-compatibility with later labs but are never set, editable, or displayed to the Requester in Lab 2. |
