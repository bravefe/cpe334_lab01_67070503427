...
- Name: lab-03\user-administration.spec.ts >> E2E-07: the self-deactivation control is disabled
- Location: e2e\lab-03\user-administration.spec.ts:23:5
...
- generic [ref=e2]:
  - navigation [ref=e3]:
    - strong [ref=e4]:
      ...
      - text: TokTockIT
    - generic "Admin" [ref=e6]:
      - generic [aria-hidden] [ref=e7]: ▣
    - generic [ref=e9] [cursor=pointer]:
      - generic [ref=e10]:
        - generic [ref=e11]: Elrond
        - generic [ref=e12]: Half-elven
      - generic [ref=e13]: ADMINISTRATOR
  - main [ref=e14]:
    - generic [ref=e15]:
      - generic [ref=e16]:
        - heading "Users" [level=1] [ref=e17]
        - paragraph [ref=e18]: Create and manage user accounts.
      - button "Create User" [ref=e19] [cursor=pointer]
    - generic [ref=e20]:
      - generic [ref=e21]:
        - text: Search users
        - textbox "Search users" [ref=e22]:
          - /placeholder: Search users…
      - generic [ref=e23]:
        - text: Role
        - combobox "Role filter" [ref=e24]:
          - option "All roles" [selected]
          - option "Requester"
          - option "IT Staff"
          - option "Administrator"
    - generic [ref=e25]:
      - heading "Unable to load users." [level=2] [ref=e26]
      - paragraph [ref=e27]: Authentication is required.
