...
>Specification: defines the product behavior and design. Engineering contract: defines the specification plus the evidence required to prove it is complete. 
